    ...
    <div class="col-xs-12">
		<div class="box">
            <div class="box-header">
                <h3 class="box-title">List of Services To Be Paid Today</h3>
            </div><!-- /.box-header -->
            <div class="box-body">
                    ...
                    <tbody>                
                        @foreach ($schedules as $schedule)
                            <tr>
                                ...
                                <td>
                                    <b>Service ID: <a href="{{ route('loans.show', array($schedule->loan->id)) }}">{{ $schedule->loan->loan_identity }}</a></b><br>
                                    Loan Amount: <b>Tsh {{ number_format($schedule->loan->amount, 2) }}/-</b><br>
                                    Service Type: <b>{{ $schedule->loan->type->name }}</b><br>
                                ...
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu" role="menu">
                                            ...
                                            <li class="divider"></li>
                                            <li><a href="{{ route('loans.show', array($schedule->loan->id)) }}">Service Details</a></li>
                                            <li class="divider"></li>
