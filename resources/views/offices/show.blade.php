	    	...
	    	<div class="box-body box-profile">
	      		...
	      		<ul class="list-group list-group-unbordered">
	        		<li class="list-group-item">
	          			<b>Services</b>
	          			<p class="text-muted">{{ $office->loans->count() }} {{ str_plural('Service', $office->loans->count())}}</p>
	        		</li>
		    		<li class="list-group-item">
	          			<b>Clients</b>
	...
	<div class="col-md-9">
	  	<div class="nav-tabs-custom">
	    	<ul class="nav nav-tabs">
	      		<li class="active"><a href="#loans" data-toggle="tab">Services</a></li>
		    	 	...
		    	 	<table id="xa" class="table table-bordered table-striped table-hover">
	                	...
	                	<tbody>        
		                	@foreach ($office->loans as $loan)
		                		<tr>
		                			<td>
		                				<a href="{{ route('loans.show', array($loan->id)) }}">Service ID: <b>{{ $loan->loan_identity }}</b></a><br>
		                	...
		                	@foreach ($office->clients as $client)
		                		<tr>
		                			<td>
		                				...
		                				Total Loans: <b>{{ $client->loans->count() }} {{ str_plural('Service', $client->loans->count())}}</b>
		                			</td>
		                			<td>
