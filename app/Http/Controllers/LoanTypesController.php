...
class LoanTypesController extends Controller
{
    ...
    public function store(LoanTypeFormRequest $request)
    {
        ...
        Alert::success('New Service Type Registered!');
    ...
    public function update(LoanTypeEditFormRequest $request, $id)
    {
        ...
        Alert::success('Service Type Edited Successfully!');
    ...
    public function destroy($id)
    {
        ...
        if ($type->loan->count() > 0) {
            Alert::error('Service Type has Services Registered. Please Remove The Services First!', 'Error')->persistent('Close');
        ...
        Alert::success('Service Type Removed Successfully!');
