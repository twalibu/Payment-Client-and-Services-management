...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <!-- Dashboard -->
            <li class="{{ active_class(if_uri(['tools/summary'])) }}"><a href="{{ url('tools/summary') }}"><i class="fa fa-dashboard"></i> <span>Dashboard</span></a></li>

            <!-- To Do Links -->
            <li class="{{ active_class(if_uri(['payments', 'payments/create'])) }}"><a href="{{ url('payments') }}"><i class="fa fa-money"></i> <span>TASK TO DO</span></a></li>

            <!-- Apointment Links -->
            <!-- <li class="{{ active_class(if_uri(['payments', 'payments/create'])) }}"><a href="{{ url('payments') }}"><i class="fa fa-money"></i> <span>Payments</span></a></li> -->

            <!-- Cases Links -->
            <li class="{{ active_class(if_uri(['loans', 'loans/create'])) }}"><a href="{{ url('loans') }}"><i class="fa fa-cube"></i> <span>Add service</span></a></li>
            ...
            <!-- Invoice Links -->
            <li class="{{ active_class(if_uri(['offices', 'invoices/create'])) }}"><a href="{{ url('invoices') }}"><i class="fa fa-home"></i> <span>Invoices</span></a></li>
            ...
            <li class="treeview {{ active_class(if_uri(['sales', 'sales/create', 'loanTypes', 'loanTypes/create', 'loanOverdues', 'loanOverdues/create', 'paymentMethods', 'paymentMethods/create', 'types', 'types/create', 'schedules', 'roles', 'roles/create'])) }}">
                ...
                <ul class="treeview-menu">
                    ...
                    <li><a href="{{ url('loanTypes') }}">Service( eg.Tracking ) Types</a></li>
