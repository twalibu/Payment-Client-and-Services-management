...
<!-- Page Description -->
@section('desc')Service Details @stop
        	...
        	<div class="box-body">              	
	            ...
	            @endif
              	...
              	<a id="deleteLoan" class="btn btn-app">
                	<i class="fa fa-remove"></i> Delete Service
              	</a>
	  	...
	  	<div class="box box-warning">
	    	<div class="box-body box-profile">
	      		...
	      		<ul class="list-group list-group-unbordered">
	        		...
	        		</li>	        		<div class="callout callout-info">
	...
	<div class="col-md-9">
	  	<div class="nav-tabs-custom">
	    	<ul class="nav nav-tabs">
	      		<li class="active"><a href="#schedule" data-toggle="tab">Service Payment Schedule</a></li>
	      		<li><a href="#payments" data-toggle="tab">Service Payments</a></li>
	    	</ul>
