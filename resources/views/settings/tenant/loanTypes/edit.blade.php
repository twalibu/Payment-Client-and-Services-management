...
<!-- Page Title -->
@section('title')SerServices Types @stop
...
<!-- Page Header -->
@section('header')Edit Services Type @stop

<!-- Page Description -->
@section('desc')Edit Services Type Details @stop

<!-- Active Link -->
@section('active')Services Types @stop
