...
<!-- Page Title -->
@section('title')Service Payments @stop
...
<!-- Page Header -->
@section('header')Service Payments @stop

<!-- Page Description -->
@section('desc')Service Payments Dashboard @stop

<!-- Active Link -->
@section('active')Service Payments @stop
    ...
    <div class="col-xs-12">
		<div class="box">
            <div class="box-header">
                <h3 class="box-title">List of All Service Payments</h3>              
                    ...
                    <tbody>                
                        @foreach ($payments as $payment)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('loans.show', array($payment->loan->id)) }}">Service ID: <b>{{ $payment->loan->loan_identity }}</b></a><br>
                                    Service Amount: <b>Tsh {{ number_format($payment->loan->amount, 2) }}</b><br>
                                </td>
                                <td>
