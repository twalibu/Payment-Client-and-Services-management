...
<!-- Page Header -->
@section('header')Add Invoice @stop

<!-- Page Description -->
@section('desc')Create New Invoicece @stop
    ...
    <div class="col-md-12"> 
        ...
        <div class="wizard-container">
            <div class="card wizard-card" data-color="blue" id="wizard">
                <form action="{{ route('offices.store') }}" method="POST" accept-charset="UTF-8">
