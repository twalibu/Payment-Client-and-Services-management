...
<!-- Page Header -->
@section('header')Add Service Type @stop

<!-- Page Description -->
@section('desc')Create New Service Type @stop

<!-- Active Link -->
@section('active')Service Types @Service
...
<div class="row">
	<div class="col-md-12"> 
        ...
        <div class="wizard-container">
            <div class="card wizard-card" data-color="blue" id="wizard">
                <form action="{{ route('loanTypes.store') }}" method="POST" accept-charset="UTF-8">
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group">
                                        ...
                                        <div class="form-group label-floating">
                                            <label class="control-label">Service Type Name(eg:Tracking)</label>
 ...
 -->                                        <!-- <div class="form-group label-floating">
                                            ...
                                            <input name="interest" type="number" value="{{ old('interest') }}" class="form-control">
                                        </div> -->
                                    </div>
